#@tissues=("hs");
#@tissues=("hs","mm","dm");
#please first run FU_hundred.R
@tissues=("hs","mm","dm","cj","mf","cs","gg","dr","pt","rm","at","osj","zm");
foreach $tissue (@tissues){
my $dir="download/hundredbed/".$tissue;
...
$hashcelltypeTOnum{$tmpcelltype}=&GetNum("download/hundredbed/".$tissue."/".$tmpcelltype.".txt");
}
}
...
{   
    ...
    $dirA="download/hundredbed/".$tissue."/".$fileA.".txt";
    $dirB="download/hundredbed/".$tissue."/".$fileB.".txt";
